...
protocol DeepLinkInfoPresenterProtocol: WelcomePresenterProtocol {
...
class DeepLinkInfoPresenter {
  ...
  init(view: WelcomeViewProtocol, router: DeepLinkInfoRouterProtocol, deeplink: URL?) {
    self.view = view
    self.router = router
...
extension DeepLinkInfoPresenter: DeepLinkInfoPresenterProtocol {
  func configure() {
